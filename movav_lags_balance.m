for vars_lag = 364 %, 390, 450, 500, 560, 600, 660, 730] % in days
%% load & reshape 7 
...
movav_19(:,:,7:12)=movmean(mat_19(:,:,7:12),7);
...
save(['movav_' num2str(vars_lag) '_19new.mat'],'mat_temp_19');
writematrix(mat_temp_19,['movav_' num2str(vars_lag) '_19new.csv']);
